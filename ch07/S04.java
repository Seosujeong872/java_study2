...
//         Champ[] champsArray = new Champ[2];
//         champsArray[0] = new 애쉬();
//         champsArray[1] = new 케이틀린();

//         for (int i = 0; i < champsArray.length; i++) {
//             champsArray[i].skill.plusPoint();
//             // 항상 같은 메소드를 사용하기 때문에
//             // 메소드 이름에 대한 고민을 할 필요가 없어서
//             // 신뢰성이 높아진다.
//             System.out.println(champsArray[i].skill.getDamage());
//         }
